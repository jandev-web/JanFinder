...
def _build_test_placeholders(franchise_id):
    return {
        ...
        "[CONTRACT_TIMESTAMP]": "Jan 01, 2025 3:42 PM",
...
def lambda_handler(event, context):
    ...
    try:
        ...
        base = f"members/franchise/{franchise_id}/templates/contract"
        template_key = f"{base}/contract-template.docx"
        test_docx_key = f"{base}/contract-template-test.docx"
        test_pdf_key  = f"{base}/contract-template-test.pdf"
