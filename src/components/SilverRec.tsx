...
const SilverRec: React.FC<PackageProps> = ({ quotePackage, recPackage, type, handleSelect }) => {
    ...
    return (
        <div>
            <div className={`min-w-[240px] relative overflow-hidden bg-white rounded-2xl shadow-lg p-6 text-center hover:shadow-xl transition-shadow duration-300 ${rec ? 'border-4 border-green-700' : ''} flex flex-col justify-between h-full`}>
                ...
                <div className='flex-shrink-0'>
                    {/* Select Button */}
                    {chosen ? (
                        <p className="font-medium text-green-700 py2">Selected!</p>
                    ) : (
                        <button
