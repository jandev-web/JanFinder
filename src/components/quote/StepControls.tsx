...
export default function StepControls({
  ...
  const errorText = isLastStep
    ? 'Please fix the errors above before confirming your quote.'
    : 'Please complete the required fields for this step, then click Continue.';
