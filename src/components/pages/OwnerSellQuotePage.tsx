...
import OwnerSellQuote from '@/components/OwnerSellQuote';
...
const OwnerSellQuotePage: React.FC<OwnerSellQuoteProps> = ({ user, quoteID }) => {
    ...
    return (
        <div className="flex flex-col w-full min-h-screen">
            ...
            <OwnerSellQuote user={ownerData} quoteID={quoteID}/>
            <OwnerFooter />
        </div>
    );
...
export default OwnerSellQuotePage;
