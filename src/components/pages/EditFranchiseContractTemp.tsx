...
import EditFranchiseContractComponent from '@/components/EditFranchiseContractComponent';
import fetchOwnerById from '@/utils/getOwnerById';

interface EditFranchiseContractProps {
  user: any;
}

const EditFranchiseContract: React.FC<EditFranchiseContractProps> = ({ user }) => {
  ...
  return (
    <div className="max-w-md mx-auto bg-white p-6">
      ...
      <EditFranchiseContractComponent franchise={franchise} user={user} />
      {loading && <p>Loading...</p>}
...
export default EditFranchiseContract;
