...
import uploadOwnerPic from '@/utils/uploadOwnerProfilePic';
import updateOwnerInfo from '@/utils/updateOwnerInfo'; // Utility to update user info
...
const EditOwnerProfileComponent: React.FC<EditProfileProps> = ({ user }) => {
        ...
        if (newPic) {
            if (selectedFile) {
                try {
                  ...
                  await uploadOwnerPic(user.sub, selectedFile);
...
export default EditOwnerProfileComponent;
