...
import EditFranchiseNameComponent from '@/components/EditFranchiseNameComponent';
import fetchOwnerById from '@/utils/getOwnerById';

interface EditFranchiseNameProps {
  user: any;
}

const EditFranchiseName: React.FC<EditFranchiseNameProps> = ({ user }) => {
  ...
  return (
    <div className="max-w-md mx-auto bg-white p-6">
      ...
      <EditFranchiseNameComponent franchise={franchise} />
      {loading && <p>Loading...</p>}
...
export default EditFranchiseName;
