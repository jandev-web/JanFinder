...
import FranchiseQuotes from '@/components/FranchiseQuotes'
...
interface FranchiseQuotesPageProps {
    user: any;
}

const FranchiseQuotesPage: React.FC<FranchiseQuotesPageProps> = ({ user }) => {
    ...
    return (
        <div className="flex flex-col min-h-screen">
            ...
            <div className='pt-24'>
                <FranchiseQuotes user={ownerData} />
            </div>
            <OwnerFooter />
...
export default FranchiseQuotesPage;
