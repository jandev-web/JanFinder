...
import OwnerFranchiseQuote from '../OwnerFranchiseQuote';
...
const OwnerFranchiseQuotePage: React.FC<OwnerFranchiseQuoteProps> = ({ user, quoteID }) => {
    ...
    return (
        <div className="flex flex-col w-full min-h-screen">
            ...
            <OwnerFranchiseQuote user={ownerData} quoteID={quoteID}/>
            <OwnerFooter />
        </div>
    );
...
export default OwnerFranchiseQuotePage;
