    ...
    return (
        <div className="max-w-3xl mx-auto bg-white shadow-lg rounded-lg border border-gray-300 p-6">
            ...
            <div className="flex items-center mb-6">
                ...
                <button
                    onClick={() => router.push('/business/owner/franchise/edit-name')}
            ...
            <div className="flex items-center">
                ...
                <button
                    onClick={() => router.push('/business/owner/franchise/edit-template/quote')}
                    className="ml-auto px-4 py-2 bg-yellow-500 text-[#001F54] font-semibold rounded hover:bg-yellow-400 transition"
                >
                    Edit
                </button>
            ...
            <div className="flex items-center">
                ...
                <button
                    onClick={() => router.push('/business/owner/franchise/edit-template/contract')}
                    className="ml-auto px-4 py-2 bg-yellow-500 text-[#001F54] font-semibold rounded hover:bg-yellow-400 transition"
                >
                    Edit
                </button>
