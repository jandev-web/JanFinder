const uploadOwnerPic = async (ID, pic) => {
    const apiKey = process.env.NEXT_PUBLIC_UPLOAD_OWNER_PROFILE_KEY;
    const url = process.env.NEXT_PUBLIC_UPLOAD_OWNER_PROFILE_URL;
