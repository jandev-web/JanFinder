...
def load_template_stream(franchise_id, rid):
    candidates = [
        ...
        f"public/members/franchise/{franchise_id}/templates/quote/quote-template.docx",
        # If you configured "protected" level for uploader
        f"protected/members/franchise/{franchise_id}/templates/quote/quote-template.docx",
        # Older/custom location you had in code
        f"protected/quote-templates/{franchise_id}/quote-template.docx",
        # Fallback simple
        f"public/quote-templates/{franchise_id}/quote-template.docx",
    ]
    last_err = None
